...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=responses/manage" class="btn btn-flat btn-dark"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-dark dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  		Action
