...
if(isset($_GET['id']) && !empty($_GET['id'])){
    $id = $_GET['id'];
    // Using wildcard to match any ID starting with the provided value
    $qry = $conn->query("SELECT q.id, r.response_message, q.question FROM `questions` q INNER JOIN `responses` r ON q.response_id = r.id WHERE q.id LIKE '{$id}%'");
...
<div class="card card-outline card-info">
			...
			<div class="form-group">
				...
				<div class="input-group col-lg-6">
                    ...
                    <div class="input-group-append">
                      <a href="javascript:void(0)" class="input-group-text  bg-dark" id="add_question"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary bg-dark" form="response-form">Save</button>
