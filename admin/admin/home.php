...
<script>
  ...
  datasets: [
    {
      label               : 'Frequent Asks',
      backgroundColor     : 'rgba(169,169,169,0.9)', // Gray color with opacity 0.9
      borderColor         : 'rgba(169,169,169,0.8)', // Gray color with opacity 0.8
      pointRadius         : false,
      pointColor          : '#A9A9A9', // Gray color
      pointStrokeColor    : 'rgba(169,169,169,1)', // Gray color with opacity 1
      pointHighlightFill  : '#A9A9A9', // Gray color
      pointHighlightStroke: 'rgba(169,169,169,1)', // Gray color with opacity 1
      data                : [<?php echo implode(',',$data) ?>]
    }
  ]
}
